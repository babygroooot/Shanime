...
class TopMangaPagingSource(
    private val getTopManga: suspend (type: String, filter: String, page: Int, limit: Int) -> NetworkResult<TopMangaResponseDTO, ErrorDTO>,
) : PagingSource<Int, TopMangaDTO>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, TopMangaDTO> = try {
        val currentPage = params.key ?: 1
        val response = getTopManga("", "bypopularity", currentPage, ITEM_LIMIT)
