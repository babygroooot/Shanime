...
class AiringAnimePagingSource(
    private val getAiringAnime: suspend (filter: String, sfw: Boolean, unapproved: Boolean, continuing: Boolean, page: Int, limit: Int) -> NetworkResult<AiringSeasonalAnimeResponseDTO, ErrorDTO>,
